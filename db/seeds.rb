...
tag5 = Tag.create(usos: 5, content: "Informatica")
tag6 = Tag.create(usos: 1, content: "Ingenieria")
tag7 = Tag.create(usos: 1, content: "Matematica")
tag8 = Tag.create(usos: 2, content: "Probabilidades")
tag9 = Tag.create(usos: 1, content: "Estadistica")
...
question1 = Question.create(title:  "¿como derivar 5x?"                             , numanswers: 0, content: "hola, como derivo esto?"                                      , user_id: 1, votes: 0, visits: 10, tags: [tag1,tag2]             , university_id: 1)
question2 = Question.create(title:  "¿integral de 34e^x?"                           , numanswers: 2, content: "hola, me cuesta integrar"                                     , user_id: 2, votes: 9, visits: 20, tags: [tag3]                  , university_id: 2)
question3 = Question.create(title:  "¿acordes de 7ma?"                              , numanswers: 0, content: "hola, que son estos acordes?"                                 , user_id: 3, votes: 0, visits: 33, tags: [tag1,tag5, tag7]       , university_id: 3)
question4 = Question.create(title:  "¿metabolismo de los perros?"                   , numanswers: 4, content: "hola, quiero saber mas sobre los perros"                      , user_id: 4, votes: 5, visits: 22, tags: [tag6]                  , university_id: 4)
question5 = Question.create(title:  "¿las ballenas azules?"                         , numanswers: 2, content: "hola, tengo una duda sobre las ballenas"                      , user_id: 1, votes: 1, visits: 30, tags: [tag4, tag5]            , university_id: 1)
question6 = Question.create(title:  "¿modo mixolidio?"                              , numanswers: 0, content: "buen dia, estaba leyendo sobre los modos griegos y..."        , user_id: 5, votes: 0, visits: 44, tags: [tag4, tag8]            , university_id: 5)
question7 = Question.create(title:  "¿que son las ondas electromagneticas?"         , numanswers: 0, content: "buen dia, estaba leyendo sobre la luz y no entiendo esto"     , user_id: 2, votes: 0, visits: 55, tags: [tag3]                  , university_id: 2)
question8 = Question.create(title:  "¿algoritmo mergesort?"                         , numanswers: 0, content: "hola, alguno tiene este algoritmo?"                           , user_id: 3, votes: 2, visits: 66, tags: [tag1,tag5, tag9]       , university_id: 3)
question9 = Question.create(title:  "¿la tierra es plana?"                          , numanswers: 0, content: "acabo de escuchar una teoria sobre esto, es real?"            , user_id: 5, votes: 0, visits: 11, tags: [tag2,tag4]             , university_id: 5)
question10 = Question.create(title: "¿que construyen las hormigas?"                 , numanswers: 0, content: "hola, hacen un castillo para su reina?"                       , user_id: 7, votes: 0, visits: 0, tags: [tag3,tag5]             , university_id: 1)
question11 = Question.create(title: "¿los iluminatis existen?"                      , numanswers: 1, content: "que pruebas hay, como me uno?"                                , user_id: 3, votes: 0, visits: 0, tags: [tag5, tag1, tag4, tag8], university_id: 3)
question12 = Question.create(title: "¿que madera es de mejor calidad, roble o pino?", numanswers: 1, content: "hola, queria comprar unos muebles y no se cuales son mejores?", user_id: 1, votes: 0, visits: 99, tags: [tag3]                  , university_id: 1)
question13 = Question.create(title: "¿por qué no lo soñó?"                          , numanswers: 0, content: "estaba escuchando la cancion y me pregunto?"                  , user_id: 1, votes: 0, visits: 0, tags: [tag3]                  , university_id: 1)
