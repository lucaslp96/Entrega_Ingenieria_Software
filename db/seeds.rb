...
question1 = Question.create :title => "pregunta 1?", :content => "hola, tengo una duda sobre algo", :user_id => 1, :votes => 0, :visits => 0
question2 = Question.create :title => "pregunta 2?", :content => "hola, tengo una duda sobre algo", :user_id => 1, :votes => 0, :visits => 0
question3 = Question.create :title => "pregunta 3?", :content => "hola, tengo una duda sobre algo", :user_id => 1, :votes => 0, :visits => 0
question4 = Question.create :title => "pregunta 4?", :content => "hola, tengo una duda sobre algo", :user_id => 1, :votes => 0, :visits => 0
question5 = Question.create :title => "pregunta 5?", :content => "hola, tengo una duda sobre algo", :user_id => 1, :votes => 0, :visits => 0
question6 = Question.create :title => "pregunta 6?", :content => "hola, tengo una duda sobre algo", :user_id => 1, :votes => 0, :visits => 0
