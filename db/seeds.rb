...
question3 = Question.create(title:  "¿acordes de 7ma?"                              , numanswers: 0, content: "hola, que son estos acordes?"                                 , user: user3, votes: 0, visits: 33, tags: [tag1,tag5, tag7]       , university_id: 3)
...
question5 = Question.create(title:  "¿las ballenas azules?"                         , numanswers: 2, content: "hola, tengo una duda sobre las ballenas"                      , user: user1, votes: 1, visits: 30, tags: [tag4, tag5]            , university_id: 1)
