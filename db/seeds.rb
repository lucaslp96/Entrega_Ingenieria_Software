...
question1 = Question.create :title => "pregunta 1?", :content => "hola, tengo una duda sobre algo", user: user1, :votes => 0, :visits => 0, tags: [tag1,tag2]
question2 = Question.create :title => "pregunta 2?", :content => "hola, tengo una duda sobre algo", user: user2, :votes => 0, :visits => 0, tags: [tag3]
question3 = Question.create :title => "pregunta 3?", :content => "hola, tengo una duda sobre algo", user: user1, :votes => 0, :visits => 0, tags: [tag4, tag5]
question4 = Question.create :title => "pregunta 4?", :content => "hola, tengo una duda sobre algo", user: user4, :votes => 0, :visits => 0, tags: [tag2]
question5 = Question.create :title => "pregunta 5?", :content => "hola, tengo una duda sobre algo", user: user3, :votes => 0, :visits => 0, tags: [tag1,tag5]
question6 = Question.create :title => "pregunta 6?", :content => "hola, tengo una duda sobre algo", user: user5, :votes => 0, :visits => 0, tags: [tag4]
