...
uni1 = University.create(name: "UNLP", question_uses: 3)
uni2 = University.create(name: "UNRN", question_uses: 3)
uni3 = University.create(name: "UNC", question_uses: 0)
uni4 = University.create(name: "UNS", question_uses: 0)
...
user1 = User.create(name: "Juan", email: "Juan@example.com", password: "user123", points: 200, university_id: uni1, tags: [tag4])
user2 = User.create(name: "Augusto", email: "Augusto@example.com", password: "user123", points: 2000, university_id: uni2, tags: [tag4])
user3 = User.create(name: "Lucas", email: "Lucas@example.com", password: "user123", points: 500, tags: [tag4])
user4 = User.create(name: "Pedro", email: "Pedro@example.com", password: "user123", points: 2000, tags: [tag4])
...
question2 = Question.create(title: "¿integral de 34e^x?", numanswers: 2, content: "hola, me cuesta integrar", user: user2, votes: 300, visits: 4520, tags: [tag3], university_id: 2)
...
question7 = Question.create(title: "¿que son las ondas electromagneticas??", numanswers: 0, content: "buen dia, estaba leyendo sobre la luz y no entiendo esto", user: user2, votes: 10, visits: 60, tags: [tag3], university_id: 2)
...
question10 = Question.create(title: "¿que construyen las hormigas?", numanswers: 0, content: "hola, hacen un castillo para su reina?", user: user2, votes: 7, visits: 23, tags: [tag3,tag5], university_id: 2)
question11 = Question.create(title: "¿los iluminatis existen?", numanswers: 1, content: "que pruebas hay, como me uno?", user: user3, votes: 0, visits: 01, tags: [tag5])
question12 = Question.create(title: "¿que madera es de mejor calidad, roble o pino?", numanswers: 1, content: "hola, queria comprar unos muebles y no se cuales son mejores?", user: user1, votes: 0, visits: 01, tags: [tag3], university_id: 1)

answer1 = Answer.create(question_id: 2, votes: 452745, user_id: 1, content: "yo usaria matlab y listo")
answer2 = Answer.create(question_id: 2, votes: 5444, user_id: 1, content: "mejor busca el wolfram alpha que no lo tenes que bajar")
answer3 = Answer.create(question_id: 3, votes: 4534524, user_id: 2, content: "es un mito, algunas si otras no")
answer4 = Answer.create(question_id: 3, votes: 414, user_id: 6, content: "depende la especie de ballena")
answer5 = Answer.create(question_id: 4, votes: 0, user_id: 5, content: "no sabia que existia algo asi")
answer6 = Answer.create(question_id: 4, votes: 1, user_id: 3, content: "en el libro Grecia Antigua te lo explica con detalle")
answer7 = Answer.create(question_id: 4, votes: 3, user_id: 1, content: "se puede considerar interesante asldknasnfao")
answer8 = Answer.create(question_id: 4, votes: 40, user_id: 2, content: "los perros blablabla 7 años")
